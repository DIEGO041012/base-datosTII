...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="./ingreso.php">comestiblesDan</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">informacion pc</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link ensabled" href="#" >Bajas</a>
        </li>
      </ul>
