...
<body>
  ...
  <div class="col-md-3">
    ...
    <div class="invalid-feedback">
      ...
      <form id='miFormulario' class="row g-3 needs-validation"  method="post" >
            <div class="col-md-6">
        ...
        <div  class="w-full px-3">
          <button id="guardar" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Guardar
          </button>
        </div>
      </div>
